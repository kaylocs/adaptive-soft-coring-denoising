...
% ═══════════════════════════════════════
% Optimal parameters for lower noise
% ═══════════════════════════════════════
Tau1   = 0.12;   Slope1 = 0.45;    
Tau2   = 0.03;   Slope2 = 1.05;  
...
roi_c  = max(1, round(W*0.25)) : min(W, round(W*0.80));

% ═══════════════════════════════════════
% Display
% ═══════════════════════════════════════
figure('Name',        'Cameraman: Low Noise Output', ...
       'NumberTitle', 'off', ...
...
title(sprintf('2. Final Output\nPSNR: %.2f dB  |  SSIM: %.3f', ...
              psnr_final, ssim_final), 'FontSize', 10);
